...
//pub const CG: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const CH: &[u8] =
...
//pub const FM: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const FO: &[u8] =
...
//pub const GF: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const GG: &[u8] =
...
//pub const MK: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
...
//pub const MP: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const MQ: &[u8] =
...
//pub const NC: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const NE: &[u8] =
...
//pub const PM: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
//pub const PN: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const PR: &[u8] =
    include_bytes!("../../resources/countries_flags/png-16/puerto-16x16-33059.png");
//pub const PS: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const PT: &[u8] =
...
//pub const RE: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const RO: &[u8] =
...
//pub const XK: &[u8] = include_bytes!("../../resources/countries_flags/png-16/");
pub const YE: &[u8] =
...
pub fn get_flag(country: &String) -> Image {
    match country.as_str() {
        ...
        _ => Image::new(Handle::from_memory(Vec::from(UNKNOWN))).width(Length::Units(FLAGS_WIDTH)),
    }
}
