...
pub fn reserved_address_translation(language: Language, info: &str) -> String {
    match language {
        ...
        Language::PT | Language::PT_BR => format!("Endereço reservado ({info})"),
...
pub fn share_feedback_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT => "Partilhe a sua opinião",
        Language::PT_BR => "Compartilhe seu feedback",
...
pub fn capture_file_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT => "Ficheiro de captura",
        Language::PT_BR => "Arquivo de captura",
        _ => "Capture file",
    }
}
...
pub fn select_file_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT => "Selecionar ficheiro",
        Language::PT_BR => "Selecionar arquivo",
        _ => "Select file",
    }
}
...
pub fn reading_from_pcap_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT => {
            "A ler pacotes do ficheiro...\n\n\
                                 Tem a certeza que o ficheiro selecionado não está vazio?"
        }
        Language::PT_BR => {
            "Lendo pacotes do arquivo...\n\n\
                                 Tem certeza que o arquivo selecionado não está vazio?"
        }
        _ => {
            "Reading packets from file...\n\n\
                                Are you sure the file you selected isn't empty?"
...
pub fn data_exceeded_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT | Language::PT_BR => "Limite de dados excedido",
...
pub fn bits_exceeded_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT | Language::PT_BR => "Limite de bits excedido",
...
pub fn pause_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT | Language::PT_BR => "Pausar",
        _ => "Pause",
    }
}
...
pub fn resume_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT | Language::PT_BR => "Retomar",
        _ => "Resume",
    }
}
