...
pub fn choose_adapters_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Hãy chọn network adapter để quan sát",
    })
}
...
pub fn select_filters_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Hãy chọn bộ lọc cho lưu lượng mạng",
    })
}
...
pub fn traffic_rate_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Lưu lượng truy cập",
    })
}
...
pub fn ask_quit_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Bạn có chắc là muốn thoát phiên phân tích này?",
    })
}
...
pub fn quit_analysis_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Thoát phiên phân tích",
    }
}
...
pub fn ask_clear_all_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Bạn có chắc là muốn xóa các thông báo?",
    })
}
...
pub fn no_addresses_translation(language: Language, adapter: &str) -> Text<'static, StyleType> {
    ...
    Text::new(match language {
        ...
        Language::VN => format!("Không thể quan sát lưu lượng nào vì adapter mà bạn chọn không địa chỉ hoạt động...\n\n\
                                {network_adapter_translation}: {adapter}\n\n\
...
pub fn waiting_translation(language: Language, adapter: &str) -> Text<'static, StyleType> {
    ...
    Text::new(match language {
        ...
        Language::VN => format!("Chưa có lưu lượng để quan sát. Đang đợi các gói tin...\n\n\
                                 {network_adapter_translation}: {adapter}\n\n\
...
pub fn some_observed_translation(language: Language, observed: u128) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => format!("Tổng số gói tin bị chặn: {observed}\n\n\
...
pub fn filtered_packets_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Các gói tin đã được lọc",
    }
}
...
pub fn filtered_bytes_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Các bytes đã được lọc",
    }
}
...
pub fn of_total_translation(language: Language, percentage: &str) -> String {
    match language {
        ...
        Language::VN => format!("({percentage} trên tổng cộng)"),
    }
}
...
pub fn notifications_title_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Tùy chỉnh thông báo của bạn",
    })
}
...
pub fn appearance_title_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Chọn chủ đề bạn muốn",
    })
}
...
pub fn active_filters_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Bộ lọc đang hoạt động",
    }
}
...
pub fn yeti_night_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Chủ đề tối của Sniffnet",
    }
}
...
pub fn yeti_day_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Chủ đề sáng của Sniffnet",
    }
}
...
pub fn deep_sea_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Đắm chìm vào lưu lượng mạng",
    }
}
...
pub fn mon_amour_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Chủ đề mộng mơ cho những kẻ mơ mộng",
    }
}
...
pub fn outgoing_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Đang hướng ra ngoài",
    }
}
...
pub fn packets_threshold_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Báo cho tôi biết khi vượt quá ngưỡng gói tin",
    }
}
...
pub fn bytes_threshold_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Báo cho tôi biết khi vượt quá ngưỡng bytes",
    }
}
...
pub fn specify_multiples_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "bạn cũng có thể chọn 'K', 'M' and 'G'",
    }
}
...
pub fn favorite_notification_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Báo cho tôi biết khi dữ liệu mới được trao đổi từ mục yêu thích của tôi",
    }
}
...
pub fn bytes_exceeded_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Bytes đã vượt ngưỡng!",
    }
}
...
pub fn bytes_exceeded_value_translation(language: Language, value: &str) -> String {
    match language {
        ...
        Language::VN => format!("{value} đã được trao đổi"),
    }
}
...
pub fn packets_exceeded_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Gói tin đã vượt ngưỡng!",
    }
}
...
pub fn favorite_transmitted_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Mục ưa thích vừa có trao đổi!",
    }
}
...
pub fn no_notifications_set_translation(language: Language) -> Text<'static, StyleType> {
    Text::new(match language {
        ...
        Language::VN => "Bạn chưa bật tính năng thông báo!\n\n\
...
pub fn only_last_30_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::VN => "Chỉ có 30 thông báo gần nhất được hiển thị",
    }
}
