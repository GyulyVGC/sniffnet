...
pub fn protocol_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::ES | Language::PT | Language::PT_BR => "Protocolo",
...
pub fn quit_analysis_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT | Language::PT_BR => "Sair da análise",
...
pub fn ask_clear_all_translation<'a>(language: Language) -> Text<'a, StyleType> {
    Text::new(match language {
        ...
        Language::PT_BR => "Tem certeza que deseja limpar as notificações?",
...
pub fn no_addresses_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT_BR => {
            "Não é possível observar tráfego porque o adaptador que selecionou não tem endereços ativos...\n\n\
                                Se tiver certeza que está conectado à internet, tente escolher um adaptador diferente."
        }
        Language::EL => {
...
pub fn error_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT | Language::PT_BR => "Ocorreu um erro!",
...
pub fn threshold_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::TR => "Eşik",
        Language::RU => "Порог",
        Language::PT | Language::PT_BR => "Limite",
        Language::EL => "όριο",
        // Language::FA => "آستانه",
        Language::SV => "Gräns",
        Language::FI => "Raja",
...
pub fn favorite_transmitted_translation(language: Language) -> &'static str {
    match language {
        ...
        Language::PT_BR => "Novos dados trocados com os favoritos",
...
pub fn no_notifications_set_translation<'a>(language: Language) -> Text<'a, StyleType> {
    Text::new(match language {
        ...
        Language::PT_BR => {
            "Você não ativou as notificações ainda!\n\n\
                                Depois de ativá-las, esta página irá mostrar um registro das suas notificações\n\n\
                                Você pode ativar as notificações nas configurações:"
        }
        Language::EL => {
