...
const W_QR: f32 = 45.0;
const W_DOMAIN: f32 = 250.0;
const W_TYPE: f32 = 60.0;
const W_RCODE: f32 = 90.0;
const W_ANSWERS: f32 = 320.0;

// Maximum characters displayed per cell before clipping.
const MAX_DOMAIN_CHARS: usize = 40;
const MAX_ANSWERS_CHARS: usize = 55;
