        ...
        Row::new()
            ...
            .push(
                Row::new()
                    ...
                    .push(Rule::horizontal(height).style(RuleType::PalettePrimary)),
            )
            .push(
                Row::new()
                    .padding(0)
                    .width(Length::Fixed(80.0))
                    .push(Rule::horizontal(height).style(RuleType::PaletteSecondary)),
            )
            .push(
                Row::new()
                    .padding(0)
                    .width(Length::Fixed(60.0))
                    .push(Rule::horizontal(height).style(RuleType::PaletteOutgoing)),
            )
            .push(
                Row::new()
                    .padding(0)
                    .width(Length::Fixed(40.0))
                    .push(Rule::horizontal(height).style(RuleType::PaletteButtons)),
            ),
    )
